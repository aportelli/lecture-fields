...
{ \footnotesize % Reduce font size
  ...
  AP would like to warmly thanks the students of the Introductory Fields and Waves course
  at the University of Edinburgh for their interest and patience, as well as the
...
% \vfill\pagebreak
% \input{exercises/transform}
% \shipoutAnswer
% \chapter{Differential equations}
% \input{chapters/diff-eq}
% \vfill\pagebreak
% \input{exercises/diff-eq}
% \shipoutAnswer
\end{document}
