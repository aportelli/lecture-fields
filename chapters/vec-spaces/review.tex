...
\begin{figure}[t]
  ...
  \caption{Parallelepiped with volume given by the triple scalar product $(\v{a},\v{b},\v{c})$.}
  \label{fig:volume}
\end{figure}
\begin{enumerate}
  \item
        If $\v{a}$, $\v{b}$ and $\v{c}$ are three concurrent edges
        of a parallelepiped, its volume is $(\v{a},\v{b},\v{c})$.
