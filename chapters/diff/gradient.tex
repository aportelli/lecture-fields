...
% \paragraph{Example:} Calculate the gradient of
% $\ds \phi(\v{r}) = r^2 = x_1^2 + x_2^2 + x_3^2\,.$
% \[
%    (\grad r^2)_1
%      = {\partial \over \partial x_1} (x_1^2 + x_2^2 + x_3^2) =  2x_1
% \]
% Similarly for $x_2$, $x_3$, and hence
% \[
%   \grad r^2 = 2\v{r}
% \]
...
\begin{enumerate}
  \item Let $\phi(\vr) = r^2 = x_1^2 + x_2^2 + x_3^2$, then
        \[
          (\grad r^2)_i
          \,=\,
          {\partial \over \partial x_i} (x_1^2 + x_2^2 +x_3^2 )
          \,=\,
...
\begin{enumerate}
  ...
  \item \textbf{Chain rule:} If $F(\phi(\vr))$ is a scalar field, then
        ...
        \[
          ...
          \,=\,
          {dF(\phi) \over d\phi} \: \frac{\partial\phi}{\partial x_i}
          \,=\,
          {dF(\phi) \over d\phi} \, \left(\grad\phi\right)_i
          %\grad  F(\phi(\vr))\ =\  
