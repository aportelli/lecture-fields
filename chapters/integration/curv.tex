...
\begin{figure}[t]
  ...
  \caption{Illustration of the flux of a velocity field through an element of surface.}
  \label{fig:flux}
\end{figure}
...
scalar area \emph{normal} to the direction of motion, that it flows through, as
illustrated in \cref{fig:flux}. This scalar area is $\diff S\cos(\theta) =
  \v{\hat{v}}\cdot \diff \v{S}$, where $\v{\hat{v}}$ is a unit vector in the direction of
$\v{v}$.
...
\begin{figure}[t]
  ...
  \caption{Illustration of the spherical curvilinear basis.}
  \label{fig:sphere_dS}
\end{figure}
...
$\phi$ fixed -- as illustrated in \cref{fig:sphere_dS}. Similarly, for $\er$ and $\ephi$.
